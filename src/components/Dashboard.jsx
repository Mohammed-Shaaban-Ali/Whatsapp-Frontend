      ...
      <div className="w-screen flex">
        ...
        <div className="w-[50%] border h-screen bg-white flex flex-col items-center">
          ...
          <div className="h-[75%] w-full border overflow-y-scroll">
            <div className=" p-14">
              <div className="max-w-[60%] w-fit bg-secondary rounded-b-xl rounded-tr-xl p-4 mb-6">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Asperiores eaque nisi accusamus
              </div>
              <div className="max-w-[60%] w-fit bg-primary text-white rounded-b-xl rounded-tr-xl p-4 ml-auto mb-6">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Asperiores eaque nisi accusamus
              </div>
              <div className="max-w-[60%] w-fit bg-secondary rounded-b-xl rounded-tr-xl p-4 mb-6">
